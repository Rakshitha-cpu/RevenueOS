...
const BATCH_RESULTS = [
  ...
  { id: "TXN_9016", customer: "Priya Venkatesh", bank: "ICICI", error: "E_504_TIMEOUT", amount: 5499, recovered: 5499, rail: "1-Tap UPI WhatsApp", status: "RECOVERED", audit: "Automated Voice Assistant sent instant UPI link" },
  { id: "TXN_9017", customer: "Aditya Kulkarni", bank: "Axis", error: "E_USER_DROPOUT", amount: 7800, recovered: 0, rail: "DNC_BLOCKED", status: "OPT_OUT_HALTED", audit: "Do Not Disturb list verified; outreach suppressed" },
  { id: "TXN_9018", customer: "Neha Aggarwal", bank: "SBI", error: "E_OTP_EXPIRED", amount: 3890, recovered: 3890, rail: "1-Tap UPI WhatsApp", status: "RECOVERED", audit: "WhatsApp re-engagement recovered cart in 32s" },
  { id: "TXN_9019", customer: "Rohan Das", bank: "HDFC", error: "E_DOUBLE_DEBIT", amount: 6400, recovered: 6400, rail: "T+0 Instant Reversal", status: "T0_REFUNDED", audit: "Instant reversal credited via NPCI IMPS pipeline" },
  { id: "TXN_9020", customer: "Sunita Reddy", bank: "Kotak", error: "E_CARD_LIMIT", amount: 19500, recovered: 19500, rail: "UPI Split Payment", status: "RECOVERED", audit: "Split checkout approved with zero interest" },
  { id: "TXN_9021", customer: "Harish Bhatt", bank: "PNB", error: "E_504_TIMEOUT", amount: 4200, recovered: 4200, rail: "1-Tap UPI WhatsApp", status: "RECOVERED", audit: "1-Tap link paid via Google Pay in 18s" },
  { id: "TXN_9022", customer: "Tanvi Desai", bank: "Canara", error: "E_USER_DROPOUT", amount: 11200, recovered: 0, rail: "DNC_BLOCKED", status: "OPT_OUT_HALTED", audit: "Customer requested cancellation; DNC rule halted outreach" },
  { id: "TXN_9023", customer: "Manish Tiwari", bank: "ICICI", error: "E_OTP_EXPIRED", amount: 8750, recovered: 8750, rail: "1-Tap UPI WhatsApp", status: "RECOVERED", audit: "PhonePe instant intent completed successfully" },
  { id: "TXN_9024", customer: "Preeti Sen", bank: "HDFC", error: "E_504_TIMEOUT", amount: 16900, recovered: 16900, rail: "1-Tap UPI WhatsApp", status: "RECOVERED", audit: "Voice Engine handled delivery objection & recovered sale" },
  { id: "TXN_9025", customer: "Naveen Chawla", bank: "Axis", error: "E_CARD_LIMIT", amount: 29900, recovered: 29900, rail: "UPI Split Payment", status: "RECOVERED", audit: "High ticket split payment plan activated" },
  { id: "TXN_9026", customer: "Swati Deshmukh", bank: "SBI", error: "E_DOUBLE_DEBIT", amount: 4500, recovered: 4500, rail: "T+0 Instant Reversal", status: "T0_REFUNDED", audit: "T+0 Reversal completed in 2.12s" },
  { id: "TXN_9027", customer: "Alok Pandey", bank: "Kotak", error: "E_USER_DROPOUT", amount: 9400, recovered: 0, rail: "DNC_BLOCKED", status: "OPT_OUT_HALTED", audit: "PolicyGuard: Wrong number signal triggered immediate DND" },
  { id: "TXN_9028", customer: "Ritu Kapoor", bank: "HDFC", error: "E_504_TIMEOUT", amount: 7600, recovered: 7600, rail: "1-Tap UPI WhatsApp", status: "RECOVERED", audit: "WhatsApp 1-tap checkout collected 7,600" },
  { id: "TXN_9029", customer: "Gautam Ghosh", bank: "ICICI", error: "E_OTP_EXPIRED", amount: 14200, recovered: 14200, rail: "1-Tap UPI WhatsApp", status: "RECOVERED", audit: "OTP timeout resolved via biometric UPI intent" },
  { id: "TXN_9030", customer: "Bhavna Mishra", bank: "PNB", error: "E_CARD_LIMIT", amount: 21000, recovered: 21000, rail: "UPI Split Payment", status: "RECOVERED", audit: "Two-stage UPI mandate approved" },
  { id: "TXN_9031", customer: "Varun Sethi", bank: "Axis", error: "E_504_TIMEOUT", amount: 3400, recovered: 3400, rail: "1-Tap UPI WhatsApp", status: "RECOVERED", audit: "Fast checkout re-route to Paytm UPI" },
  { id: "TXN_9032", customer: "Kiran Mazumdar", bank: "SBI", error: "E_DOUBLE_DEBIT", amount: 12800, recovered: 12800, rail: "T+0 Instant Reversal", status: "T0_REFUNDED", audit: "Instant reversal via NPCI UTR #904288192044" },
  { id: "TXN_9033", customer: "Abhishek Pillai", bank: "Canara", error: "E_USER_DROPOUT", amount: 6500, recovered: 0, rail: "DNC_BLOCKED", status: "OPT_OUT_HALTED", audit: "DND flag respected; zero outbound messages sent" },
  { id: "TXN_9034", customer: "Aparna Iyer", bank: "HDFC", error: "E_504_TIMEOUT", amount: 8900, recovered: 8900, rail: "1-Tap UPI WhatsApp", status: "RECOVERED", audit: "5% SAVE232 retention discount applied and verified" },
  { id: "TXN_9035", customer: "Sachin Hegde", bank: "Kotak", error: "E_OTP_EXPIRED", amount: 23400, recovered: 23400, rail: "UPI Split Payment", status: "RECOVERED", audit: "Split payment verified across two UPI accounts" },
  { id: "TXN_9036", customer: "Shreya Mathur", bank: "ICICI", error: "E_504_TIMEOUT", amount: 5100, recovered: 5100, rail: "1-Tap UPI WhatsApp", status: "RECOVERED", audit: "Voice Assistant negotiated Priority Shipping upgrade" },
  { id: "TXN_9037", customer: "Vivek Saxena", bank: "Axis", error: "E_DOUBLE_DEBIT", amount: 7200, recovered: 7200, rail: "T+0 Instant Reversal", status: "T0_REFUNDED", audit: "T+0 instant reversal executed in 2.24s" },
  { id: "TXN_9038", customer: "Radhika Singhal", bank: "SBI", error: "E_CARD_LIMIT", amount: 18200, recovered: 18200, rail: "UPI Split Payment", status: "RECOVERED", audit: "Part-1 9,100 collected immediately via GPay" },
  { id: "TXN_9039", customer: "Nikhil Chopra", bank: "PNB", error: "E_USER_DROPOUT", amount: 8240, recovered: 0, rail: "DNC_BLOCKED", status: "OPT_OUT_HALTED", audit: "Customer opt-out logged; strict DPDP compliance" },
  { id: "TXN_9040", customer: "Anjali Bansal", bank: "HDFC", error: "E_504_TIMEOUT", amount: 13500, recovered: 13500, rail: "1-Tap UPI WhatsApp", status: "RECOVERED", audit: "WhatsApp 1-tap UPI link completed in 29 seconds" },
  { id: "TXN_9041", customer: "Chetan Parekh", bank: "Canara", error: "E_OTP_EXPIRED", amount: 6700, recovered: 6700, rail: "1-Tap UPI WhatsApp", status: "RECOVERED", audit: "Instant deep link executed via Cred UPI" },
  { id: "TXN_9042", customer: "Shalini Kaushik", bank: "Kotak", error: "E_504_TIMEOUT", amount: 4900, recovered: 4900, rail: "1-Tap UPI WhatsApp", status: "RECOVERED", audit: "Card failure resolved with single-click UPI WhatsApp link" },
  { id: "TXN_9043", customer: "Pankaj Ahuja", bank: "ICICI", error: "E_CARD_LIMIT", amount: 25800, recovered: 25800, rail: "UPI Split Payment", status: "RECOVERED", audit: "Split transaction authorized via PolicyGuard" },
  { id: "TXN_9044", customer: "Deepak Talwar", bank: "Axis", error: "E_DOUBLE_DEBIT", amount: 9100, recovered: 9100, rail: "T+0 Instant Reversal", status: "T0_REFUNDED", audit: "Automated webhook reversed debit in 2.15s" },
  { id: "TXN_9045", customer: "Rashmi Nayak", bank: "SBI", error: "E_504_TIMEOUT", amount: 3200, recovered: 3200, rail: "1-Tap UPI WhatsApp", status: "RECOVERED", audit: "Kannada voice agent cleared payment query" },
  { id: "TXN_9046", customer: "Gaurav Malviya", bank: "HDFC", error: "E_OTP_EXPIRED", amount: 16400, recovered: 16400, rail: "1-Tap UPI WhatsApp", status: "RECOVERED", audit: "Instant WhatsApp payment recovery finalized" },
  { id: "TXN_9047", customer: "Megha Suri", bank: "PNB", error: "E_CARD_LIMIT", amount: 31200, recovered: 31200, rail: "UPI Split Payment", status: "RECOVERED", audit: "Secured high-value cart with verified split link" },
  { id: "TXN_9048", customer: "Tarun Goel", bank: "Canara", error: "E_504_TIMEOUT", amount: 2890, recovered: 2890, rail: "1-Tap UPI WhatsApp", status: "RECOVERED", audit: "1-Tap payment link paid on Google Pay" },
  { id: "TXN_9049", customer: "Geeta Somani", bank: "Kotak", error: "E_DOUBLE_DEBIT", amount: 10500, recovered: 10500, rail: "T+0 Instant Reversal", status: "T0_REFUNDED", audit: "Immediate customer reassurance & T+0 reversal" },
  { id: "TXN_9050", customer: "Vikas Rathore", bank: "ICICI", error: "E_504_TIMEOUT", amount: 19400, recovered: 19400, rail: "1-Tap UPI WhatsApp", status: "RECOVERED", audit: "Voice assistant successfully recovered high-ticket order" }
];
